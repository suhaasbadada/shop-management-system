...
if(count($_POST)!=0)
{
	extract($_POST);
	extract($_GET);
	$query="update inventory set Product_ID='$Product_ID', Unit_or_Quantity='$Unit_or_Quantity', TBV='$TBV', PriceUnit='$PriceUnit', Distributor_ID='$Distributor_ID' where Sno='$Sno'";
				...
				<form method="post">
					<div class="card">
						<div class="card-header bg-dark">
							<h1 class="text-center text-white">Insert</h1>
						</div>
